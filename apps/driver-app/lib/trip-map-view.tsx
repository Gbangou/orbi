...
.pickup-pin-label{background:rgba(11,11,11,.92);color:#FFFFFF;font-family:-apple-system,sans-serif;font-size:10px;font-weight:700;padding:2px 6px;border-radius:4px;letter-spacing:.3px;white-space:nowrap}
...
.dest-pin-label{background:rgba(11,11,11,.92);color:#FFFFFF;font-family:-apple-system,sans-serif;font-size:10px;font-weight:700;padding:2px 6px;border-radius:4px;letter-spacing:.3px;white-space:nowrap}
.you-label{position:relative;background:rgba(11,11,11,.92);color:#FFFFFF;font-family:-apple-system,sans-serif;font-size:10px;font-weight:800;padding:3px 7px;border-radius:7px;white-space:nowrap;border:1px solid rgba(255,255,255,.42);box-shadow:0 4px 10px rgba(0,0,0,.20)}
</style>
</head>
<body>
<div id="map"></div>
