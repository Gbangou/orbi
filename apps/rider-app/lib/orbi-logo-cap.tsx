 ...
 *
 * GEOMETRIE :
 *   Container width  = c.ring
 *   Container height = c.cap_h + c.ring - c.overlap
 *   Capsule : top=0, centree, hauteur c.cap_h, largeur c.cap_w, borderRadius cap_w/2
 *   Anneau  : top = c.cap_h - c.overlap, width=height=c.ring, borderRadius=ring/2
 *   Le chevauchement (overlap) de 1-2 px soude visuellement capsule et anneau.
 */
