  ...
  return (
    ...
    >
      ...
      <View style={{ width: c.s, height: c.s }}>
        ...
        {/* Point-vehicule (origine des arcs) */}
        <View
          style={{
            position: 'absolute',
            left: ox - c.dot / 2,
...
/**
 * Arc quart-de-cercle (de 15h vers 12h) centre sur (ox, oy).
 * Clip: conteneur r×r a (ox, oy-r), overflow hidden.
 * Cercle: 2r×2r a left=-r, top=0 dans le conteneur → centre a (ox, oy).
 */
function Arc({
  r,
  ox,
